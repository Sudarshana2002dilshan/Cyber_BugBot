...
async function connectToWA() {
  ...
  console.log("Connecting ❤️匚𝐘𝐁𝐄𝐑 ᗪιℓѕнαη❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️匚𝐘𝐁𝐄𝐑 ᗪιℓѕнαη❤️ installed successful ✅");
      console.log("❤️匚𝐘𝐁𝐄𝐑 ᗪιℓѕнαη❤️ connected to whatsapp ✅");

      let up = `❤️匚𝐘𝐁𝐄𝐑 ᗪιℓѕнαη❤️ connected successful ✅`;
      let up1 = `Hello Dilshan, I made bot successful`;
      ...
      robin.sendMessage("94765529447@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Sudarshana2002dilshan/bot-helper/refs/heads/main/8cd141fd-204e-487c-b86d-006fa3ddfd1b.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️匚𝐘𝐁𝐄𝐑 ᗪιℓѕнαη❤️ started✅");
});
app.listen(port, () =>
